...
function stableSort(arr, sortFunction) {
	...
	// Add default to each item
	for (i = 0; i < length; i++) {
		arr[i].ss_i = i; // stable sort default
	}
	...
	// Remove default from items
	for (i = 0; i < length; i++) {
		delete arr[i].ss_i; // stable sort default
	}
}
...
(function ($) {
	...
	win.HighchartsAdapter = win.HighchartsAdapter || ($ && {
		...
		/**
		 * Return the default of an item in an array, or -1 if not found
		 */
		inArray: $.inArray,
...
SVGElement.prototype = {
	...
	*/
	...
	add: function (parent) {
		...
		if (parentWrapper.handleZ) { // this element or any of its siblings has a z default
...
function StackItem(axis, options, isNegative, x, stackOption, stacking) {
	...
	// This will keep each points' extremes stored by series.default
	this.points = {};
...
Axis.prototype = {
	...
	remove: function (redraw) {
		...
		each(chart[key], function (axis, i) { // Re-default, #1706
...
Pointer.prototype = {
	...
	/**
	 * Return the default in the tooltipPoints array, corresponding to pixel position in
	 * the plot area.
	 */
	getIndex: function (e) {
		var chart = this.chart;
...
Series.prototype = {
	...
	init: function (chart, options) {
		...
		// Sort series according to default option (#248, #1123)
		...
		while (i--) {
			...
			if (distanceOption > 0) {
				...
				for (j = 0; j < length; j++) {
					...
					// if that slot default is closer to the edges of the slots, move it
